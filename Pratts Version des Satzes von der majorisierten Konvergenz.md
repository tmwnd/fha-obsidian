...
- $\forall n \in \mathbb{N} : g_n, G_n$ sind $\mu$-[[mu-Integrierbarkeit|integrierbar]]
- $g, G$ sind $\mu$-[[mu-Integrierbarkeit|integrierbar]]
...
Dann ist $f$ $\mu$-[[mu-Integrierbarkeit|integrierbar]] und es gilt
