Sei $(X_n)_{n \in \mathbb{N}_0}$ eine [[zettel/Markov-Kette|Markov-Kette]], $h : \left( (\mathbb{R}^p)^{\mathbb{N}_0}, (\mathscr{B}^p)^{\mathbb{N}_0} \right) \to (\mathbb{R}, \mathscr{B})$ beschränkt mit
