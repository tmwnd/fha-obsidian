Sei $X : (\Omega, \mathcal{A}) \to (R, \mathscr{S})$ eine [[zettel/Zufallsvariable|Zufallsvariable]], $x \in R$ eine Beobachtung von $X$, $\text{H}$ die Hypothese eines [[zettel/Statistisches Testproblem|statistischen Testproblems]].
